...
const STRIPE_PRICE_CITIZENSHIP_20 = process.env.STRIPE_PRICE_CITIZENSHIP_20 || 'price_1TPHR9J1zGpc7hJ0KRkJbBlV';
const STRIPE_PRICE_CITIZENSHIP_50 = process.env.STRIPE_PRICE_CITIZENSHIP_50 || 'price_1TPHa8J1zGpc7hJ07fdtV2Un';
const STRIPE_PRICE_CITIZENSHIP_100 = process.env.STRIPE_PRICE_CITIZENSHIP_100 || 'price_1TPHa8J1zGpc7hJ0SmJdoKuv';
const STRIPE_PRICE_CITIZENSHIP_UNLIMITED = process.env.STRIPE_PRICE_CITIZENSHIP_UNLIMITED || 'price_1TPHa8J1zGpc7hJ0vYOJD06X';
...
app.post('/create-checkout-session', async (req, res, next) => {
  try {
    ...
    const successUrl = buildStripeReturnUrl(STRIPE_SUCCESS_PATH, {
      plan: config.code,
      paid: '1',
...
app.get('/checkout/verify-session', async (req, res, next) => {
  try {
    ...
    return res.json({
      ok: paid && productOk && planMatches && priceMatches,
      paid,
      verified: paid && productOk && planMatches && priceMatches,
