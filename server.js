...
function drawHeader(doc) {
  doc.save();
  doc.roundedRect(40, 32, 515, 76, 14).fill('#0b1f3a');
  doc.fillColor('#ffffff').font('Helvetica-Bold').fontSize(20).text('Bircan Migration & Education', 58, 54);
  doc.fillColor('#ffffff').font('Helvetica').fontSize(10).text('Preliminary Visa Assessment Letter', 58, 80);
  doc.circle(515, 70, 22).lineWidth(2).strokeColor('#8fb4ff').stroke();
  doc.fillColor('#8fb4ff').font('Helvetica-Bold').fontSize(14).text('BM', 505, 64, { width: 20, align: 'center' });
  doc.restore();
