...
function drawPageChrome(doc) {
  ...
  doc.fillColor('#5f6b7d').font('Helvetica').fontSize(9)
    .text('Bircan Migration & Education | Preliminary assessment letter', 40, footerY, { width: 350 })
    .text(`Page ${doc.page.number}`, 470, footerY, { width: 85, align: 'right' });
...
function addMetaGrid(doc, rows) {
  rows.forEach((row, index) => {
    ...
    doc.fillColor('#0b1f3a').font('Helvetica-Bold').fontSize(10).text(row[0], 50, y + 5, { width: 145 });
