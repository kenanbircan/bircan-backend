...
app.get('/api/health', asyncRoute(async (_req, res) => {
  ...
  res.json({
    ...
    version: '13.0.0-act-regs-pam-code-trained-engine',
    postgres: true,
    jsonFallback: false,
    ...
    migrationEngine: 'act-regulations-pam-code-trained-delegate-simulator-v13',
    evidenceValidationLayer: 'enabled',
    codeOfConductSafeguards: 'enabled',
...
function buildLegalEnginePdfInputs(assessment) {
  ...
  // Surface evidence validation in the PDF bundle when the renderer supports it.
