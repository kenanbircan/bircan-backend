...
function drawHeader(doc) {
  ...
  if (hasLogo) {
    doc.image(logoPath, 40, 36, { fit: [120, 72], align: 'left', valign: 'top' });
  }

  const textX = hasLogo ? 172 : 40;
  const textWidth = hasLogo ? 235 : 367;

  doc.fillColor('#172033').font('Helvetica-Bold').fontSize(20).text('Bircan Migration & Education', textX, 42, {
    width: textWidth,
    lineBreak: false,
  });
  doc.fillColor('#5f6b7d').font('Helvetica').fontSize(10).text('Migration advice and professional visa assessment services', textX, 68, {
    width: textWidth + 40,
  });

  doc.fillColor('#172033').font('Helvetica-Bold').fontSize(11).text('Kenan Bircan JP', 390, 42, {
    width: 140,
    align: 'right',
    lineBreak: false,
  });
  doc.fillColor('#172033').font('Helvetica').fontSize(8.8).text('Registered Migration Agent', 390, 58, {
    width: 140,
    align: 'right',
    lineBreak: false,
  });
  doc.text('MARN: 1463685 | MMIA: 10497', 390, 72, {
    width: 140,
    align: 'right',
    lineBreak: false,
  });
  doc.text('CMA: 20156912 | JP No: 218851', 390, 84, {
    width: 140,
    align: 'right',
    lineBreak: false,
  });
