...
function normalisePayload(payload) {
  ...
  const base = payload.formPayload && typeof payload.formPayload === 'object' ? payload.formPayload
    : payload.answers && typeof payload.answers === 'object' ? payload.answers
    : payload.rawSubmission && typeof payload.rawSubmission === 'object' ? payload.rawSubmission
    : payload;
  const flat = payload.flatAnswers && typeof payload.flatAnswers === 'object' ? payload.flatAnswers : {};
  return { ...flat, ...base };
}
