...
const RENDERER_VERSION = 'pdf-js-merged-premium-advice-renderer-v1-20260522';
  ...
  return htmlDocument(`${html(BRAND.name)} - Professional Migration Advice`, `
    <section class="cover premium-cover page-break-after">
      <div class="cover-band">
        <div class="logo-card">
          ${tryReadLogoDataUri() ? `<img src="${tryReadLogoDataUri()}" alt="Bircan Migration"/>` : `<div class="logo-text">BIRCAN<br/><span>MIGRATION</span></div>`}
        </div>
      ...
      <div class="confidential-card avoid-break">
        <h2>Confidential professional advice</h2>
        ${para('This advice letter is prepared from the information presently available. It is subject to review of original evidence, current law, Departmental records, conflict checks and final migration-agent review before lodgement action. No guarantee of visa grant is given.')}
      </div>
    </section>
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  h1 { margin: 0 0 8pt 0; color: #082246; font-size: 18pt; line-height: 1.18; page-break-after: avoid; }
  h2 { margin: 13pt 0 6pt 0; color: #082246; font-size: 12.2pt; line-height: 1.25; page-break-after: avoid; }
  h3 { margin: 8pt 0 4pt 0; color: #102f56; font-size: 10pt; }
  p { margin: 0 0 8pt 0; }
  ...
  body::before {
    ...
    height: 9mm;
    padding-top: 2mm;
    border-bottom: .5pt solid #d9e1ec;
    color: #082246;
    font-size: 8pt;
    font-weight: 700;
    z-index: 10;
  ...
  body::after {
    content: 'Professional Migration Advice Letter';
    position: fixed;
    top: -7mm;
    right: 16mm;
    height: 9mm;
  ...
  .cover::before, .cover::after { display: none; content: none; }

  .premium-cover { margin: -16mm -16mm 0 -16mm; min-height: 281mm; position: relative; }
  .cover-band {
    position: relative;
    min-height: 106mm;
    ...
    color: #fff;
    overflow: hidden;
    border-bottom: 5mm solid #d5a63f;
  }
  .cover-circle { position: absolute; border-radius: 50%; background: rgba(31,94,255,.18); }
  .circle-one { width: 54mm; height: 54mm; right: 16mm; top: -8mm; }
  .circle-two { width: 32mm; height: 32mm; right: 43mm; top: 42mm; background: rgba(213,166,63,.16); }
  .logo-card { width: 60mm; min-height: 25mm; border-radius: 6mm; background: #fff; display: flex; align-items: center; justify-content: center; padding: 4mm 8mm; box-shadow: 0 8pt 20pt rgba(0,0,0,.10); position: relative; z-index: 2; }
  .logo-card img { max-width: 46mm; max-height: 18mm; object-fit: contain; }
  .logo-text { color:#082246; font-size: 15pt; font-weight: 800; line-height: .92; letter-spacing: .02em; text-align: center; }
  .logo-text span { font-size: 8pt; letter-spacing: .22em; }
  .brand-line { position: absolute; top: 30mm; left: 82mm; right: 18mm; color: #dbe7f8; font-size: 10.2pt; z-index: 2; }
  .gold-rule { width: 65mm; height: 1.2pt; background: #d5a63f; margin: 8mm 0 5mm 0; position: relative; z-index: 2; }
  .cover-title { color: #fff; font-size: 30pt; line-height: 1.09; margin: 0; letter-spacing: -.02em; position: relative; z-index: 2; }
  .cover-subtitle { margin-top: 4mm; color: #c9d7ee; font-size: 12pt; position: relative; z-index: 2; }
  .matter-card { margin: 22mm 18mm 0 18mm; padding: 10mm 12mm; background: #f3f6fb; border: 1.2pt solid #dbe4ef; border-radius: 8mm; }
  .matter-card h2 { margin-top: 0; font-size: 15pt; }
  .confidential-card { margin: 12mm 18mm 0 18mm; padding: 7mm 9mm; border: 1.1pt solid #ead99e; background: #fffaf0; border-radius: 6mm; }
  .confidential-card h2 { margin-top: 0; font-size: 11.5pt; color: #082246; }

  main { padding-top: 4mm; }
  main h1 { padding-bottom: 5pt; border-bottom: 1.3pt solid #d5a63f; margin-top: 9pt; }
  main > h1:first-child { margin-top: 0; }
  .kv { width: 100%; border: 1px solid #dbe3ee; border-radius: 6pt; overflow: hidden; margin: 5pt 0 12pt 0; page-break-inside: avoid; }
  .kv-row { display: grid; grid-template-columns: 31% 69%; border-bottom: 1px solid #dbe3ee; min-height: 22pt; }
  .kv-row:last-child { border-bottom: 0; }
  .kv-key { background: #f1f5fa; color: #314258; font-weight: 800; padding: 6pt 8pt; text-transform: none; }
  .kv-val { background: #fff; padding: 6pt 8pt; }

  .advice-block { border: 1px solid #dbe3ee; border-radius: 8pt; background: #fbfdff; padding: 6pt 8pt; margin: 0 0 6pt 0; page-break-inside: avoid; }
  .block-label { color: #082246; font-size: 8.7pt; font-weight: 800; margin-bottom: 2pt; }
  .block-value { color: #172033; }
  .finding, .risk, .appendix-item { border: 1px solid #e2e9f2; border-radius: 7pt; padding: 7pt 8pt; margin: 8pt 0 10pt 0; page-break-inside: avoid; background: #fff; }
  .finding h2, .risk h2, .appendix-item h2 { margin-top: 0; }
  .risk:nth-of-type(odd), .appendix-item:nth-of-type(odd) { background: #fbfdff; }
