...
async function callOpenAIForAdvice(facts, rules){
  ...
  const requiredReasoning=[
    ...
    'Quality flags must identify weaknesses in facts/evidence; do not use them as filler.'
  ].join('\n- ');
...
Deterministic rule findings to treat as ground truth unless contradicted by clearer facts:
