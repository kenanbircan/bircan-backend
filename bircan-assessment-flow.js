// Backwards compatible wrapper. New pages should load bircan-auth.js and bircan-checkout.js.
(function(){
  if(window.BircanAssessmentFlow) return;
  ...
  window.BircanAssessmentFlow={
    startLoginThenCheckout:function({assessmentPayload,plan,subclass}){
      ...
      const pending={assessmentPayload,plan,subclass,applicantEmail,savedAt:new Date().toISOString()};
