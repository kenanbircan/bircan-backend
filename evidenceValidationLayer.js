...
function validateEvidenceForAssessment(assessment) {
  ...
  return {
    ...
    version: '2.0.0-act-regs-pam-code-trained',
    trainingSources: { knowledgebase: 'KNOWLEDGEBASE(3).zip', migrationAct: 'Migration Act 1958-current(1).zip', migrationRegulations: 'Migration Regulations 1994-current(1).zip', codeOfConduct: 'Code of Conduct current from 1 March 2022' },
